---
title: Popup Chat!
description: Tutorial on how to make Popup chat with framer motion
date: 2023-06-20
---
...
<div className="flex w-full items-center justify-center border-lg">
  <img src="/popup-chat.gif" className="rounded-lg" alt="popup chat" />
</div>
...
<div className="flex w-full items-center justify-center border-lg">
  <img src="/rotating-chat.gif" className="rounded-lg" alt="rotating chat" />
</div>
